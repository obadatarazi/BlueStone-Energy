...
const translations = {
  en: {
    ...
    contact_subtitle: "Blue Stone Energy LLC — Global offices across strategic markets",
    locations_title: "Our Global Offices",
    locations_subtitle: "Connect with Blue Stone Energy at any of our locations worldwide.",
    location_office_label: "Office",
    location_view_map: "View on map",
    location_usa: "USA",
    location_usa_city: "Houston, Texas",
    location_usa_office: "Energy Corridor",
    location_korea: "Korea",
    location_korea_city: "Seoul",
    location_ksa: "KSA",
    location_ksa_city: "Riyadh",
    location_syria: "Syria",
    location_syria_city: "Deir ez-Zor & Damascus",
    location_syria_deir: "Deir ez-Zor",
    location_syria_damascus: "Damascus",
    footer_locations: "Locations",
    location_footer_usa: "Houston, TX — Energy Corridor",
    location_footer_korea: "Seoul, Korea",
    location_footer_ksa: "Riyadh, KSA",
    location_footer_syria: "Deir ez-Zor & Damascus",
    form_section_title: "Send Us a Message",
    form_section_subtitle: "Reach out to our team and we will respond within 24–48 business hours.",
    form_name: "Name *",
  ...
  ar: {
    ...
    contact_subtitle: "بلو ستون للطاقة ذ.م.م — مكاتب عالمية في الأسواق الاستراتيجية",
    locations_title: "مكاتبنا حول العالم",
    locations_subtitle: "تواصل مع بلو ستون للطاقة في أي من مواقعنا العالمية.",
    location_office_label: "مكتب",
    location_view_map: "عرض على الخريطة",
    location_usa: "الولايات المتحدة",
    location_usa_city: "هيوستن، تكساس",
    location_usa_office: "ممر الطاقة",
    location_korea: "كوريا",
    location_korea_city: "سيول",
    location_ksa: "المملكة العربية السعودية",
    location_ksa_city: "الرياض",
    location_syria: "سوريا",
    location_syria_city: "دير الزور ودمشق",
    location_syria_deir: "دير الزور",
    location_syria_damascus: "دمشق",
    footer_locations: "المواقع",
    location_footer_usa: "هيوستن، تكساس — ممر الطاقة",
    location_footer_korea: "سيول، كوريا",
    location_footer_ksa: "الرياض، المملكة العربية السعودية",
    location_footer_syria: "دير الزور ودمشق",
    form_section_title: "أرسل لنا رسالة",
    form_section_subtitle: "تواصل مع فريقنا وسنرد خلال 24–48 ساعة عمل.",
    form_name: "الاسم *",
    form_company: "الشركة *",
